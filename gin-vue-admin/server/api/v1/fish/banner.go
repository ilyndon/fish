...
var bannerService = service.ServiceGroupApp.FishServiceGroup.BannerService
...
// @accept application/json
// @Produce application/json
// @Param data body fish.Banner true "删除Banner"
...
// @accept application/json
// @Produce application/json
// @Param data body fish.Banner true "更新Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query fish.Banner true "用id查询Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query fishReq.BannerSearch true "分页获取Banner列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /banner/getBannerList [get]
func (bannerApi *BannerApi) GetBannerList(c *gin.Context) {
	var pageInfo fishReq.BannerSearch
