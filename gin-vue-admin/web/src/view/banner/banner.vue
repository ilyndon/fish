<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="轮播图的图片地址" prop="url" width="240">
          <template #default="scope">
            <el-image style="width: 100px; height: 80px" :src="scope.row.url" fit="cover" />
          </template>
        </el-table-column>>
        <el-table-column align="left" label="轮播图介绍" prop="description" width="240" />
        <el-table-column align="left" label="轮播图点击跳转的地址" prop="path" width="240" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        <el-form-item label="轮播图的图片地址:"  prop="url" >
        ...
        <el-form-item label="轮播图点击跳转的地址:"  prop="path" >
